...
export const BusinessInfoProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // This effect pushes business info to the dataLayer once loaded.
  // This data can be used by Google Tag Manager to configure tags,
  // such as dynamic call tracking for Google Ads.
  useEffect(() => {
    if (!businessInfo.isLoading && businessInfo.phone && businessInfo.phone !== 'Loading...') {
      ...
      console.log('Business info pushed to dataLayer for GTM:', { phone: businessInfo.phone });
    }
