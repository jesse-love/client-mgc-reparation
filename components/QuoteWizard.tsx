                             ...
                             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    {!wizardData.appointmentDate ? (
                                        // FIX: Use t.quoteWizard.appointment for translations
                                        <div className="h-full text-sm p-2 flex items-center justify-center bg-gray-50 dark:bg-slate-700 rounded-md text-gray-500 dark:text-gray-400">{t.quoteWizard.appointment.selectDateFirst}</div>
