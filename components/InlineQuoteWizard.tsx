    ...
    if (isSubmitted) {
        return (
            <div className="text-center p-4 min-h-[500px] flex flex-col justify-center items-center bg-green-50 dark:bg-green-900/20 rounded-lg">
                ...
                <h2 className="text-2xl font-bold font-oswald text-slate-800 dark:text-white">{t.quoteWizard.success.title}</h2>
                <p className="mt-2 text-slate-600 dark:text-slate-300">{t.quoteWizard.success.message}</p>
                <button onClick={handleReset} className="mt-6 bg-orange-500 text-slate-900 font-bold py-3 px-6 rounded-md hover:bg-orange-400 transition duration-300">
    ...
    const renderContent = () => {
        switch (step) {
            case 1:
                return (
                    <div>
                        <h3 className="text-2xl font-oswald font-bold text-slate-800 dark:text-white mb-6 text-center">{t.quoteWizard.steps[1].title}</h3>
                        <div className="space-y-4">
                            <button onClick={() => handleSelectOption('vehicleType', 'Car/SUV/Light Truck')} className="w-full text-left p-4 border-2 border-slate-300 dark:border-slate-600 rounded-lg hover:border-orange-500 dark:hover:border-orange-500 hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-all flex items-center text-lg">
                            ...
                            <button onClick={() => handleSelectOption('vehicleType', 'Heavy Truck')} className="w-full text-left p-4 border-2 border-slate-300 dark:border-slate-600 rounded-lg hover:border-orange-500 dark:hover:border-orange-500 hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-all flex items-center text-lg">
                            ...
                            <button onClick={() => handleSelectOption('vehicleType', 'Trailer/Other')} className="w-full text-left p-4 border-2 border-slate-300 dark:border-slate-600 rounded-lg hover:border-orange-500 dark:hover:border-orange-500 hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-all flex items-center text-lg">
            ...
            case 2:
                 return (
                    <div>
                        <h3 className="text-2xl font-oswald font-bold text-slate-800 dark:text-white mb-6 text-center">{t.quoteWizard.steps[2].title}</h3>
                        <div className="space-y-4">
                            <button onClick={() => handleSelectOption('serviceCategory', 'Maintenance/Inspection')} className="w-full text-left p-4 border-2 border-slate-300 dark:border-slate-600 rounded-lg hover:border-orange-500 dark:hover:border-orange-500 hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-all flex items-center text-lg">
                                <SquaresPlusIcon className="h-8 w-8 text-orange-500 mr-4"/>
                                <span className="font-semibold text-slate-800 dark:text-slate-100">{t.quoteWizard.steps[2].options.maintenance}</span>
                            </button>
                            <button onClick={() => handleSelectOption('serviceCategory', 'Specific Repair')} className="w-full text-left p-4 border-2 border-slate-300 dark:border-slate-600 rounded-lg hover:border-orange-500 dark:hover:border-orange-500 hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-all flex items-center text-lg">
                                <BugAntIcon className="h-8 w-8 text-orange-500 mr-4"/>
                            ...
                            <button onClick={() => handleSelectOption('serviceCategory', 'Diagnostics/Not Sure')} className="w-full text-left p-4 border-2 border-slate-300 dark:border-slate-600 rounded-lg hover:border-orange-500 dark:hover:border-orange-500 hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-all flex items-center text-lg">
                                <DocumentMagnifyingGlassIcon className="h-8 w-8 text-orange-500 mr-4"/>
                                <span className="font-semibold text-slate-800 dark:text-slate-100">{t.quoteWizard.steps[2].options.diagnostics}</span>
                            </button>
                        </div>
                         <div className="mt-6">
                            <button type="button" onClick={handleBack} className="text-sm font-semibold text-slate-600 dark:text-slate-300 hover:text-orange-500">&larr; {t.quoteWizard.buttons.back}</button>
                         </div>
                    </div>
                );
            case 3:
                 return (
                    <div>
                         <h3 className="text-2xl font-oswald font-bold text-slate-800 dark:text-white mb-6 text-center">{t.quoteWizard.steps[3].title}</h3>
                         <form onSubmit={handleSubmit} className="space-y-4">
                            <textarea id="description" name="description" rows={3} required value={wizardData.description} onChange={handleChange} className="w-full px-4 py-3 border-2 border-slate-300 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 dark:bg-slate-800 dark:border-slate-600 dark:text-white text-base" placeholder={t.quoteWizard.steps[3].descriptionPlaceholder}></textarea>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <input type="text" name="fullName" placeholder={t.quoteWizard.steps[3].fullName} required value={wizardData.fullName} onChange={handleChange} className="w-full px-4 py-3 border-2 border-slate-300 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 dark:bg-slate-800 dark:border-slate-600 dark:text-white" />
                                <input type="tel" name="phone" placeholder={t.quoteWizard.steps[3].phone} required value={wizardData.phone} onChange={handleChange} className="w-full px-4 py-3 border-2 border-slate-300 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 dark:bg-slate-800 dark:border-slate-600 dark:text-white" />
                            </div>
                            <input type="email" name="email" placeholder={t.quoteWizard.steps[3].email} required value={wizardData.email} onChange={handleChange} className="w-full px-4 py-3 border-2 border-slate-300 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 dark:bg-slate-800 dark:border-slate-600 dark:text-white" />
                            
                             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="relative" ref={datePickerRef}>
                                    <div className="relative">
                                    <input type="text" id="appointmentDate" name="appointmentDate" readOnly value={wizardData.appointmentDate} onClick={() => setIsDatePickerOpen(!isDatePickerOpen)} placeholder={t.contactForm.appointmentDatePlaceholder} className="w-full pl-12 pr-4 py-3 border-2 border-slate-300 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 cursor-pointer dark:bg-slate-800 dark:border-slate-600 dark:text-white" />
                                ...
                                <div>
                                     {!wizardData.appointmentDate ? (
                                        <div className="h-full text-sm p-2 flex items-center justify-center bg-slate-100 dark:bg-slate-900/50 rounded-md text-slate-500 dark:text-slate-400">{t.contactForm.selectDateFirst}</div>
                                        ...
                                        <select 
                                            ...
                                            className="h-full block w-full pl-3 pr-10 py-3 text-base border-2 border-slate-300 focus:outline-none focus:ring-orange-500 focus:border-orange-500 rounded-md dark:bg-slate-800 dark:border-slate-600 dark:text-white"
                                        >
