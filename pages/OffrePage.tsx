...
const OffrePage: React.FC = () => {
    ...
    const pageContent = t.ppl.offre;
    const testimonials = PPL_TESTIMONIALS.offre;

    return (
        <>
            <MetaTags 
                title="Inspection de Freins GRATUITE à Terrebonne | MGC Réparation"
                description="Bruit de freins suspect? Obtenez un diagnostic honnête et une inspection 100% GRATUITE de vos freins chez MGC Réparation à Terrebonne. Réponse rapide."
            />
