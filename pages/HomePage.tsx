    ...
    return (
        <section className="relative min-h-screen flex flex-col justify-center text-white bg-brand-dark">
            ...
            <div className="relative z-10 text-center px-4 flex-grow flex flex-col justify-center max-w-6xl mx-auto pt-20">
                ...
                <div className="mt-12">
                    <button onClick={() => openWizard()} className="bg-orange-500 text-slate-900 font-bold py-3 px-8 md:py-4 md:px-10 rounded-md hover:bg-orange-400 transition-all duration-300 text-lg transform hover:scale-105 shadow-xl hover:shadow-2xl hover:shadow-orange-500/30">
                        {t.home.hero.ctaBook}
                    </button>
                </div>
            </div>
