...
import { DocumentMagnifyingGlassIcon, HandThumbUpIcon, CurrencyDollarIcon } from '@heroicons/react/24/solid';
      ...
      <div className="flex flex-col flex-grow">
        <div className="flex-grow flex items-center justify-center">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl text-center py-12">
            ...
            <div className="inline-block bg-blue-600 text-white px-4 py-1 rounded-full font-bold text-sm mb-6">
              {content.badgeText ? content.badgeText.replace('{city}', city) : `🛡️ The "Honest Mechanic" Guarantee in ${city}`}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left max-w-4xl mx-auto mb-10">
              <div className="bg-slate-800/50 p-6 rounded-lg border border-slate-700">
                <DocumentMagnifyingGlassIcon className="h-10 w-10 text-blue-500 mb-3" />
              ...
              <div className="bg-slate-800/50 p-6 rounded-lg border border-slate-700">
                <HandThumbUpIcon className="h-10 w-10 text-orange-500 mb-3" />
