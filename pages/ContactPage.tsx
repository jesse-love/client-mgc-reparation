      ...
      <nav aria-label="Breadcrumb" className="bg-gray-50 border-b border-gray-200">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <ol role="list" className="flex items-center space-x-2 py-4">
              ...
              <li>
                <span className="text-sm font-medium text-gray-500">{t.breadcrumbs.contact}</span>
              </li>
            </ol>
        </div>
      </nav>
      <div className="py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-4xl lg:text-5xl font-extrabold text-brand-dark">{t.contact.title}</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-3 bg-white p-8 rounded-lg shadow-lg">
              <h2 className="text-2xl font-bold text-brand-dark mb-6">{t.contact.formTitle}</h2>
              <ContactForm />
            </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="bg-white p-8 rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold text-brand-dark mb-4">{t.contact.infoTitle}</h3>
                <ul className="space-y-4 text-gray-700">
                  <li className="flex items-start">
                    <MapPinIcon className="h-6 w-6 mt-1 mr-4 flex-shrink-0 text-orange-500" />
                    <div>
                      <strong className="block">{t.contact.address}</strong>
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      <strong className="block">{t.contact.phone}</strong>
                  ...
                  <li className="flex items-start">
                    ...
                    <div>
                      <strong className="block">{t.contact.email}</strong>
