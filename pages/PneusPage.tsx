...
const PneusPage: React.FC = () => {
    ...
    const pageContent = t.ppl.pneus;
    const testimonials = PPL_TESTIMONIALS.pneus;

    return (
        <>
            <MetaTags 
                title="Changement de Pneus + Inspection de Freins GRATUITE | Terrebonne"
                description="Économisez du temps! Faites votre changement de pneus à Terrebonne et obtenez une inspection de freins GRATUITE (valeur 99$) en même temps. Service 2-en-1 efficace."
            />
